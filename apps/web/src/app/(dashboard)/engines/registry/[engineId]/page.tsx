...
> = {
  'swiss-ephemeris': {
    ...
    endpoints: [
      ...
      'ephemeris.patterns — Grand Trine, T-Square, Yod, Stellium, etc.',
      'ephemeris.solarReturn — Solar return chart for a year',
      'ephemeris.transitCalendar — Transit events in date range',
      'ephemeris.profections — Annual profections (lord of the year)',
      'ephemeris.panchanga — Vedic 5-limb day analysis',
      'ephemeris.dasha — Vimshottari dasha periods (120yr cycle)',
      'ephemeris.synastry — Cross-chart aspects between two people',
      'ephemeris.composite — Midpoint composite chart',
      'ephemeris.arabicParts — 10 Arabic Parts/Lots with house placement',
      'ephemeris.planetaryHours — 24 Chaldean planetary hours',
      'ephemeris.solarCondition — Combust, cazimi, under beams',
      'ephemeris.midpoints — All midpoints with activations',
      'ephemeris.bradley — Bradley siderograph (financial)',
