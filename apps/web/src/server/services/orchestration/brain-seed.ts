...
const W: WorkspaceDef[] = [
  ...
  },
  {
    ...
    type: 'general',
    goal: 'Product strategy, discovery, prioritization, and PM artifacts — 47 specialist agents from Product-Manager-Skills',
    icon: 'product',
    agents: [
      // Component Skills (20)
      [
        ...
        'specialist',
        'reasoning',
        ['user-stories', 'acceptance-criteria', 'gherkin', 'agile'],
        'Mike Cohn format user stories with Gherkin acceptance criteria',
      ],
      [
        'Positioning Statement',
        'specialist',
        'reasoning',
        ['positioning', 'go-to-market', 'competitive-analysis'],
        'Geoffrey Moore positioning framework specialist',
      ],
      [
        'PRD Development',
        'planner',
        'reasoning',
        ['prd', 'requirements', 'product-specs'],
        'Structured PRD creation across eight phases',
      ],
      [
        'Jobs To Be Done',
        'specialist',
        'reasoning',
        ['jtbd', 'customer-research', 'innovation'],
        'JTBD framework for understanding customer motivations',
      ],
      [
        'Press Release',
        'specialist',
        'reasoning',
        ['working-backwards', 'product-vision', 'amazon-method'],
        'Amazon Working Backwards press release methodology',
      ],
      [
        'Proto Persona',
        'specialist',
        'reasoning',
        ['personas', 'user-research', 'segmentation'],
        'Assumption-based persona profiles for hypothesis validation',
      ],
      [
        'Customer Journey Map',
        'specialist',
        'reasoning',
        ['journey-mapping', 'touchpoints', 'experience-design'],
      ...
      [
        ...
        'specialist',
        'reasoning',
        ['epics', 'hypothesis-testing', 'outcome-driven'],
        'Frame epics as testable hypotheses with validation criteria',
      ],
      [
        'Problem Statement',
        'specialist',
        'reasoning',
        ['problem-framing', 'empathy', 'user-needs'],
        'Empathy-driven problem articulation framework',
      ],
      [
        'EOL Message',
        'specialist',
        'reasoning',
        ['end-of-life', 'communication', 'customer-care'],
        'Empathetic product discontinuation messaging',
      ],
      [
        'PESTEL Analysis',
        'specialist',
        'reasoning',
        ['macro-analysis', 'strategy', 'market-forces'],
        'Macro-environmental force analysis for product strategy',
      ],
      [
        'Storyboard',
        'specialist',
        'reasoning',
        ['narrative', 'visualization', 'user-journey'],
        'Six-frame narrative journey visualization',
      ],
      [
        'User Story Mapping',
        'specialist',
        'reasoning',
        ['story-mapping', 'release-planning', 'jeff-patton'],
        'Jeff Patton style hierarchical story maps',
      ],
      [
        'User Story Splitting',
        'specialist',
        'reasoning',
        ['story-splitting', 'agile', 'invest-criteria'],
        'Systematic story splitting using nine patterns',
      ],
      [
        'PoL Probe',
        'specialist',
        'reasoning',
        ['validation', 'experiments', 'prototyping'],
        'Lightweight validation experiment design',
      ],
      [
        'Recommendation Canvas',
        'specialist',
        'reasoning',
        ['ai-products', 'evaluation', 'business-case'],
        'AI product solution evaluation framework',
      ],
      [
        'Finance Metrics Quickref',
        'specialist',
        'reasoning',
        ['saas-metrics', 'finance', 'kpis'],
        'SaaS finance metrics reference with formulas and benchmarks',
      ],
      [
        'SaaS Economics Metrics',
        'specialist',
        'reasoning',
        ['unit-economics', 'capital-efficiency', 'saas'],
        'SaaS business viability and efficiency analysis',
      ],
      [
        'SaaS Revenue Growth',
        'specialist',
        'reasoning',
        ['revenue', 'growth-metrics', 'retention'],
        'Revenue, retention, and growth metric calculation',
      ],
      [
        'Altitude Horizon Framework',
        'specialist',
        'reasoning',
        ['career', 'leadership', 'pm-growth'],
        'PM-to-Director transition mental model',
      ],
      ...
      [
        ...
        'Framework selection for feature prioritization',
      ],
      [
        ...
        'Structured discovery from outcomes to experiments',
      ],
      [
        'Discovery Interview Prep',
        'specialist',
        'reasoning',
        ['interviews', 'user-research', 'methodology'],
        'Customer discovery interview preparation',
      ],
      [
        'Lean UX Canvas',
        'specialist',
        'reasoning',
        ['lean-ux', 'hypothesis', 'business-problems'],
        'Jeff Gothelf Lean UX Canvas facilitation',
      ],
      [
        'Epic Breakdown Advisor',
        'specialist',
        'reasoning',
        ['epic-breakdown', 'splitting', 'agile'],
        'Epic decomposition using Humanizing Work methodology',
      ],
      [
        'Acquisition Channel Advisor',
        'specialist',
        'reasoning',
        ['acquisition', 'cac', 'ltv', 'growth'],
        'Channel evaluation using unit economics',
      ],
      [
        'Feature Investment Advisor',
        'specialist',
        'reasoning',
        ['roi', 'investment', 'opportunity-cost'],
        'Feature build/no-build financial analysis',
      ],
      [
        'Finance Pricing Advisor',
        'specialist',
        'reasoning',
        ['pricing', 'arpu', 'nrr', 'churn'],
        'Pricing change financial impact modeling',
      ],
      [
        'Business Health Diagnostic',
        'specialist',
        'reasoning',
        ['business-health', 'diagnostics', 'saas'],
        'Comprehensive SaaS business health assessment',
      ],
      [
        'AI Readiness Advisor',
        'specialist',
        'reasoning',
        ['ai-strategy', 'ai-maturity', 'product-ai'],
        'AI-shaped organization readiness assessment',
      ],
      [
        'Context Engineering Advisor',
        'specialist',
        'reasoning',
        ['context-engineering', 'llm', 'rag', 'prompting'],
        'AI context design and LLM integration guidance',
      ],
      [
        'Journey Mapping Workshop',
        'specialist',
        'reasoning',
        ['workshop', 'journey-mapping', 'facilitation'],
      ...
      [
        ...
        'PM-to-Director transition coaching',
      ],
      [
        'VP CPO Readiness Advisor',
        'specialist',
        'reasoning',
        ['executive', 'vp', 'cpo', 'leadership'],
        'Director-to-VP/CPO transition guidance',
      ],
      [
        'Positioning Workshop',
        'specialist',
        'reasoning',
        ['positioning', 'april-dunford', 'workshop'],
        'April Dunford positioning methodology facilitation',
      ],
      [
        'Problem Framing Canvas',
        'specialist',
        'reasoning',
        ['problem-framing', 'reframing', 'assumptions'],
        'Three-phase problem reframing process',
      ],
      [
        'PoL Probe Advisor',
        'specialist',
        'reasoning',
        ['validation', 'prototyping', 'risk-matching'],
        'Validation method selection for product risks',
      ],
      [
        ...
        'Market sizing with top-down and bottom-up methods',
      ],
      [
        'Story Mapping Workshop',
        'specialist',
        'reasoning',
        ['workshop', 'story-mapping', 'release-planning'],
        'User story mapping workshop facilitation',
      ],
      [
        'Workshop Facilitation',
        'specialist',
        'reasoning',
        ['facilitation', 'workshops', 'decision-making'],
        'General workshop facilitation with pacing and options',
      ],
      [
        'Company Research',
        'specialist',
        ...
        'Comprehensive company profiling from public sources',
      ],
      // Workflow Skills (6)
      [
        'Discovery Process',
        'planner',
        'agentic',
        ['discovery', 'research', 'validation', 'workflow'],
        'End-to-end 3-4 week discovery cycle orchestrator',
      ],
      [
        'Product Strategy Session',
        'planner',
        'agentic',
        ['strategy', 'positioning', 'roadmap', 'workflow'],
        'Multi-week strategy development process facilitator',
      ],
      [
        'PRD Workflow',
        'planner',
        'agentic',
        ['prd', 'requirements', 'workflow'],
        'Multi-day PRD creation workflow orchestrator',
      ],
      [
        'Roadmap Planning',
        'planner',
        ...
        'Strategic roadmap planning and release sequencing',
      ],
      [
        'Executive Onboarding',
        'planner',
        'reasoning',
        ['onboarding', 'executive', '30-60-90'],
        'VP/CPO 30-60-90 day onboarding playbook',
      ],
      [
        'Skill Authoring',
        'specialist',
        'reasoning',
        ['skill-creation', 'documentation', 'standards'],
        'PM skill definition creation and maintenance',
      ],
    ],
  },
]
