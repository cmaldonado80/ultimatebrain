...
export class EphemerisEngine {
  ...
  constructor(config: EphemerisEngineConfig = {}) {
  ...
  private longitudeToPosition(lon: number): {
    sign: ZodiacSign
    degree: number
    minute: number
    notation: string
  ...
  async getRetrogrades(startDate: string, endDate: string): Promise<RetrogradePeriod[]> {
    ...
    const RETROGRADES_2026: RetrogradePeriod[] = [
      {
        planet: 'mercury',
        stationRx: '2026-01-25',
        stationDirect: '2026-02-16',
        rxSign: 'Aquarius',
        directSign: 'Aquarius',
        rxDegree: 21,
      },
      {
        planet: 'mercury',
        stationRx: '2026-05-20',
        stationDirect: '2026-06-13',
        rxSign: 'Gemini',
        directSign: 'Gemini',
        rxDegree: 15,
      },
      {
        planet: 'mercury',
        stationRx: '2026-09-17',
        stationDirect: '2026-10-09',
        rxSign: 'Libra',
        directSign: 'Virgo',
        rxDegree: 15,
      },
      {
        planet: 'venus',
        stationRx: '2026-07-23',
        stationDirect: '2026-09-04',
        rxSign: 'Virgo',
        directSign: 'Leo',
        rxDegree: 3,
      },
      {
        planet: 'mars',
        stationRx: '2026-11-10',
        stationDirect: '2027-01-21',
        rxSign: 'Gemini',
        directSign: 'Taurus',
        rxDegree: 7,
      },
      {
        planet: 'jupiter',
        stationRx: '2026-03-10',
        stationDirect: '2026-07-01',
        rxSign: 'Gemini',
        directSign: 'Gemini',
        rxDegree: 24,
      },
      {
        planet: 'saturn',
        stationRx: '2026-06-26',
        stationDirect: '2026-11-14',
        rxSign: 'Aries',
        directSign: 'Aries',
        rxDegree: 21,
      },
      {
        planet: 'uranus',
        stationRx: '2026-09-06',
        stationDirect: '2027-01-30',
        rxSign: 'Gemini',
        directSign: 'Taurus',
        rxDegree: 1,
      },
      {
        planet: 'neptune',
        stationRx: '2026-06-28',
        stationDirect: '2026-12-03',
        rxSign: 'Aries',
        directSign: 'Pisces',
        rxDegree: 2,
      },
      {
        planet: 'pluto',
        stationRx: '2026-05-03',
        stationDirect: '2026-10-10',
        rxSign: 'Aquarius',
        directSign: 'Aquarius',
        rxDegree: 7,
      },
